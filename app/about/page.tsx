...
export default function AboutPage() {
  ...
  const milestones = [
    { year: "2024", event: "Sarv Jagat founded with vision to provide quality compressed air solutions" },
  ...
  const certifications = [
    { name: "ISO 9001:2015", description: "Quality Management System", year: "2025" },
    { name: "CE Marking", description: "European Conformity Standards", year: "2025" },
  ]

  // const awards = [
  //   // { name: "Best Industrial Equipment Supplier", organization: "IndiaMart trust Awards", year: "2023" },
